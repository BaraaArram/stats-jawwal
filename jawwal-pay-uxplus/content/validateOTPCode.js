...
function setupValidationPageFlow(container) {
  ...
  const formContainer = container.querySelector('#enhanced-validation-form');
...
.summary-row{display:grid;grid-template-columns:180px 1fr;gap:16px;align-items:center;padding:14px 0;border-bottom:1px solid var(--line);}
.summary-row:last-child{border-bottom:none;}
.summary-label{font-size:13px;font-weight:700;color:var(--ink-soft);}
.summary-value{font-size:14px;color:var(--ink);padding:12px 16px;border-radius:12px;background:var(--paper);border:1px solid var(--line-strong);}
